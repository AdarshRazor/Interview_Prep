...
|---|---|---|
| Storage | Stored directly in memory | Stored as references to memory locations |
| Mutability | Immutable (cannot be changed) | Mutable (can be changed) |
| Comparison | Value comparison (e.g., ===) | Reference comparison (checks if they refer to the same object) |
| Assignment | Creates a copy of the value | Creates a reference to the same object |
| Passing as Arguments | Passed by value (a copy is passed) | Passed by reference (the original object is passed) |
